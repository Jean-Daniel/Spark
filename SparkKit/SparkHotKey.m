...
/*
 Fonction qui permet de dŽfinir la validitŽ d'un raccouci. Depuis 10.3, les raccourcis sans "modifier" sont acceptŽs.
 JugŽs trop gŽnant, seul les touches Fx peuvent tre utilisŽes sans "modifier"
*/
